...
class BoletoData(object):
    ...
    **Parâmetros não obrigatórios**:
    ...
    def __init__(self, **kwargs):
        ...
        self.data_processamento = kwargs.pop(
    ...
    def dv_nosso_numero(self):
        ...
        """
        raise NotImplementedError("This method has not been implemented by this class")
    ...
    def _cedente_endereco_set(self, endereco):
        if len(endereco) > 80:
            raise BoletoException(u"Linha de endereço possui mais que 80 caracteres")
    ...
    def _instrucoes_set(self, list_inst):
        ...
        if len(list_inst) > 7:
            raise BoletoException(u"Número de linhas de instruções maior que 7")
    ...
    def _demonstrativo_set(self, list_dem):
        ...
        if len(list_dem) > 12:
            raise BoletoException(u"Número de linhas de demonstrativo maior que 12")
