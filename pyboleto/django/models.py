...
class Boleto(models.Model):
    ...
    valor_documento = models.DecimalField(
        u"Valor do Documento", max_digits=8, decimal_places=2
    )
    ...
    data_processamento = models.DateField(u"Data de Processamento", auto_now=True)
    ...
    especie_documento = models.CharField(
        u"Espécie do Documento", max_length=255, blank=True
    )
